<div class="container">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3" style="display: flex; align-items: center;">
        ...
        <!-- Center Title -->
        <h2 class="page-header text-center" style="margin: 0 auto; flex-grow: 1; text-align: center;"> Countries</h2>
                        ...
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                echo "<tr>
                                    ...
                                    <td>
                                        <a href='/countries/".encrypt($row['id'], $key)."' class='btn btn-success' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
                                    </td>
                                </tr>";
                            }
                        ?>
