...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add'])) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: /users/$enc_last_id");
            exit();
        } else {
...
<div class="container mt-5">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3" style="display: flex; align-items: center;">
        ...
        <!-- Center Title -->
        <h2 class="page-header text-center" style="margin: 0 auto; flex-grow: 1; text-align: center;"> <?php echo $mode; ?> User</h2>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="district_id" id="districtDropdown" class="form-control" required>
                ...
                <?php $row_district_id = $row['district_id'] ?? ''; ?>
