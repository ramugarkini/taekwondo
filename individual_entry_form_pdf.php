...
$pdf->Cell(0, 40, '', 'LR', 0, 'C'); // Empty cell to create space
...
$pdf->Cell(100, 10, ($row['name'] ?? ''), 1, 1, 'C'); // Full width

// State row
$pdf->Cell(40, 10, 'State', 1, 0, 'C');
$pdf->Cell(100, 10, ($row['state_organization_name'] ?? ''), 1, 1, 'C'); // Full width
...
$pdf->Cell(20, 10, ($row['age'] ?? ''), 1, 1); // Full width
